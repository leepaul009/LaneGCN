...
wget https://s3.amazonaws.com/argoai-argoverse/hd_maps.tar.gz --no-check-certificate
...
# train + val + test
wget https://s3.amazonaws.com/argoai-argoverse/forecasting_train_v1.1.tar.gz --no-check-certificate
wget https://s3.amazonaws.com/argoai-argoverse/forecasting_val_v1.1.tar.gz --no-check-certificate
wget https://s3.amazonaws.com/argoai-argoverse/forecasting_test_v1.1.tar.gz --no-check-certificate
